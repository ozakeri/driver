...
/**
 * Created by GapCom on 11/25/2017.
 */
...
public class PersianCalendar implements Serializable {
     ...
     * Converts specified gregorian date to persian date in form of (yyyy/mm/dd)
     */
    public String getPersianDate(Date d) {
     ...
     */
    public int getPersianYear(Date dt) {
        GregorianCalendar gc = new GregorianCalendar();
        gc.setTime(dt);
     ...
     * (Months:1..12)
     */
    public int getPersianMonth(Date dt) {
        GregorianCalendar gc = new GregorianCalendar();
        gc.setTime(dt);
        int gregYear = gc.get(Calendar.YEAR);
        int gregMonth = gc.get(Calendar.MONTH) + 1;
     ...
     */
    public  int getPersianDayOfMonth(Date dt) {
        GregorianCalendar gc = new GregorianCalendar();
        gc.setTime(dt);
        int gregYear = gc.get(Calendar.YEAR);
        int gregMonth = gc.get(Calendar.MONTH) + 1;
