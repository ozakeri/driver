...
package gap.com.driver.gapcalendar.materialdatetimepicker.date;
...
import gap.com.driver.gapcalendar.materialdatetimepicker.HapticFeedbackController;
import gap.com.driver.gapcalendar.materialdatetimepicker.TypefaceHelper;
import gap.com.driver.gapcalendar.materialdatetimepicker.Utils;
import gap.com.driver.gapcalendar.materialdatetimepicker.utils.LanguageUtils;
...
public class DatePickerDialog extends DialogFragment implements
    ...
    public interface OnDateSetListener {
         ...
         */
        void onDateSet(DatePickerDialog view, int year, int monthOfYear, int dayOfMonth , String dayName);
    }
            ...
            public void onClick(View v) {
                ...
                if (mCallBack != null) {
                    mCallBack.onDateSet(DatePickerDialog.this, mPersianCalendar.getPersianYear(),
                            mPersianCalendar.getPersianMonth(), mPersianCalendar.getPersianDay(),mPersianCalendar.getPersianWeekDayName());
                }
                dismiss();
            }
        });
