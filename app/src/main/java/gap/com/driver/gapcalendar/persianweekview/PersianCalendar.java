package gap.com.driver.gapcalendar.persianweekview;
...
public class PersianCalendar {
    ...
    public int getMonthName(int irMonth) {
        switch (irMonth) {
            case 1:
                return Integer.parseInt("فروردین");
            case 2:
                return Integer.parseInt("اردیبهشت");
            case 3:
                return Integer.parseInt("خرداد");
            case 4:
                return Integer.parseInt("تیر");
            case 5:
                return Integer.parseInt("مرداد");
            case 6:
                return Integer.parseInt("شهریور");
            case 7:
                return Integer.parseInt("مهر");
            case 8:
                return Integer.parseInt("آبان");
            case 9:
                return Integer.parseInt("آذر");
            case 10:
                return Integer.parseInt("دی");
            case 11:
                return Integer.parseInt("بهمن");
            case 12:
                return Integer.parseInt("اسفند");
