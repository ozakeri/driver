...
/**
 * Created by p.baradari on 11/2/2014.
 */
public class JalaliCalendarUtil {
    ...
    public JalaliCalendarUtil(Calendar calendar) {
        setGregorianDate(calendar.get(Calendar.YEAR),
                calendar.get(Calendar.MONTH) + 1,
                calendar.get(Calendar.DAY_OF_MONTH));
    }
     ...
     * @param day   int
     */
    public JalaliCalendarUtil(int year, int month, int day) {
     ...
     * @return int
     */
    public int getIranianYear(int amount) {
        return irYear += amount;
    }
     ...
     * @return int
     */
    public int getIranianMonth(int amount) {
        irMonth += amount;
        if (irMonth < 1) {
            irMonth = 12;
            irYear += amount;
            //irYear = 12 - (irMonth % 12);
        } else if (irMonth > 12) {
            irMonth = 1;
            irYear += amount;
        }
     ...
     * @return int
     */
    public int getIranianDay(int amount) {
        irDay += amount;
     ...
     /*   if (irMonth < 1) {
        ...
        System.out.println("irDay==" + irDay);
    ...
    public String getIranianDate() {
        ...
        if (irMonth < 10)
            irMonthStr = "0" + irMonth;
        else
            irMonthStr = String.valueOf(irMonth);

        if (irDay < 10)
            irDayStr = "0" + irDay;
        else
            irDayStr = String.valueOf(irDay);

        return (irYear + "/" + irMonthStr + "/" + irDayStr);
    }
    ...
    public String getGregorianDate() {
        ...
        if (gMonth < 10)
            ...
            gMonthStr = String.valueOf(gMonth);

        if (gDay < 10)
            gDayStr = "0" + gDay;
        else
            gDayStr = String.valueOf(gDay);

        return (gYear + "/" + gMonthStr + "/" + gDayStr);
    }
