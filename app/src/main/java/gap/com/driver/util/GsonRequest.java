...
public class GsonRequest<T> extends Request<T> {
    ...
    public Map<String, String> getHeaders() throws AuthFailureError {
        ...
        {
            headers = new HashMap<>();
            String token = DriverApplication.getInstance().getSharedPreferences().getString(Constants.PREF_TOKEN, "");
            Utils.printLogs("token = " + token);
    ...
    protected VolleyError parseNetworkError(VolleyError volleyError) {
        ...
        try {
            ...
            Utils.printLogs("Error code = " + response.statusCode);

            String json = new String(
                    response.data,
                    HttpHeaderParser.parseCharset(response.headers));

            Utils.printLogs("Error json = " + json);
    ...
    protected Response<T> parseNetworkResponse(NetworkResponse response) {
        try {
            ...
            Utils.printLogs("Response code = " + response.statusCode);
            ...
            if (clazz != null)
            {
                ...
                Utils.printLogs("Response json = " + json);
