...
import gap.com.driver.model.driverprofile.Person;
import gap.com.driver.model.driverprofile.PictureAF;

public class DriverEDAList {
    ...
    @Expose
    public Integer militaryServiceStatus;
    @SerializedName("idNo")
    @Expose
    public String idNo;
    ...
    @Expose
    public String militaryServiceStatusText;
    ...
    @Expose
    public Integer watchingIsLChProcessStatus;
    @SerializedName("shiftGroupGEn_text")
    @Expose
    public String shiftGroupGEnText;
    @SerializedName("shiftTypeBaseEn")
    @Expose
    public Integer shiftTypeBaseEn;
    @SerializedName("requestedDriveLicenceEn")
    @Expose
    public Integer requestedDriveLicenceEn;
    @SerializedName("shiftTypeBaseEn_text")
    @Expose
    public String shiftTypeBaseEnText;
    @SerializedName("watchingIsLChProcessStatus_text")
    @Expose
    public String watchingIsLChProcessStatusText;
    @SerializedName("employmentDate")
    @Expose
    public String employmentDate;
    @SerializedName("driverLicenceStatus")
    @Expose
    public Integer driverLicenceStatus;
    ...
    @Expose
    public Integer backIsLChProcessStatus;
