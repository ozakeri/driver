...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSize = attributes.getInt(R.styleable.CircularProgress_circular_progress_size,
                NORMAL_SIZE);
        ...
        mDuration = attributes.getInteger(R.styleable.CircularProgress_circular_progress_duration,
