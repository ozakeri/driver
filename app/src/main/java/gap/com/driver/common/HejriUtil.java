...
public class HejriUtil {
    ...
    public static String getCurDate() {
        ...
        hejriUtil.decodeHejriDate(new Date(HejriUtil.getCurrentDate().getTime()));
    ...
    public static Date incYear(java.util.Date current) {
    ...
    public static Date incMonth(java.util.Date current, int month) {
        Calendar rightNow = Calendar.getInstance();
        rightNow.setTime(current);
    ...
    public static String incMonthInHejriDate(String startDateStr, int month) {
    ...
    public static String incYearInHejriDate(String startDateStr, int year) {
        //startDateStr = chrisToHejri(startDateStr);
    ...
    public static Date incDays(java.util.Date current, int days) {
        Calendar rightNow = Calendar.getInstance();
        rightNow.setTime(current);
    ...
    public static Date getTarikhEngheza(String tarikhShoro, int dayAdded) {
    ...
    public static Date getTarikhEngheza(String tarikhShoro) {
...
//        return (calendar.get(Calendar.HOUR_OF_DAY) + ":" + calendar.get(Calendar.MINUTE) + ":" + calendar.get(Calendar.SECOND) + " " + (hejriUtil.getYear()) + "/" + (hejriUtil.getMonth() < 10 ? "0" : "") + hejriUtil.getMonth() + "/" + hejriUtil.getDay());
    ...
    public static Date getCurrentDate() {
        ...
        currentTime.set(Calendar.SECOND, 0);
        currentTime.set(Calendar.MILLISECOND, 0);
        return new Date(currentTime.getTimeInMillis());
    }
    ...
    public static Timestamp getCurrentDateTimestamp() {
        ...
        currentTime.set(Calendar.SECOND, 0);
        currentTime.set(Calendar.MILLISECOND, 0);
        return new Timestamp(currentTime.getTimeInMillis());
    }
    ...
    public static String getHourFromDate(Timestamp date) {
        Calendar c = Calendar.getInstance();
        c.setTimeInMillis(date.getTime());
        return getWithZeroPrefix(c.get(Calendar.HOUR_OF_DAY), 2) + "";
    }

    public static String getTimeFromDateWithSecond(Timestamp date) {
        Calendar c = Calendar.getInstance();
        c.setTimeInMillis(date.getTime());
        return getWithZeroPrefix(c.get(Calendar.HOUR_OF_DAY), 2) + ":" + getWithZeroPrefix(c.get(Calendar.MINUTE), 2) + ":" + getWithZeroPrefix(c.get(Calendar.SECOND), 2);
    }

    public static String getTimeFromDate2Digit(Timestamp date) {
        Calendar c = Calendar.getInstance();
        c.setTimeInMillis(date.getTime());
    ...
    public static String getDateTimeFromDate(Timestamp date) {
        return chrisToHejri(date) + "-" + getTimeFromDate(date);
    }

    public static String getDateTimeFromDate2Digit(Timestamp date) {
    ...
    public static Timestamp convertToTimesatmp(String date, String time) {
        Calendar c = Calendar.getInstance();
    ...
    public static String incDayInHejriDate(String hejriDateStr) {
        return incDayInHejriDate(hejriDateStr, 1);

    }

    public static String incDayInHejriDate(String hejriDateStr, int days) {
        Calendar date = Calendar.getInstance();
        ...
        return chrisToHejri(new Date(date.getTimeInMillis()));
    }
