...
public class MonthFragment extends Fragment implements View.OnClickListener {
    ...
    private Globals globalValue = Globals.getInstance();
    ...
    /*    int currentItem = mPager.getCurrentItem();
        ...
        if (view.getId() == R.id.next) {
            ...
            if (mCallback.getMonth() - 1 == 11) {
                ...
                initPager(mCallback.getYear(), mCallback.getMonth() - 12);
            }
            ...
            if (!globalValue.isLeavePage() && p.getPersianMonth() - 6 == currentItem){
                return;
            }else if (globalValue.isLeavePage()){
                return;
            }
